...
static int print_help(char **argv) {
  ...
  cout << "Usage:\n " << argv[0]
       ...
       << endl;
  cout
      << "Available Aruco dictionaries: DICT_4X4_50, DICT_4X4_100, "
         "DICT_4X4_250, "
...
static void StereoCalib(const vector<string> &imagelist, Size inputBoardSize,
                        string type, float squareSize, 
                        // float markerSize,
                        // cv::aruco::PredefinedDictionaryType arucoDict,
                        // string arucoDictFile,
                        bool displayCorners = false, bool useCalibrated = true,
  ...
  for (i = j = 0; i < nimages; i++) {
    for (k = 0; k < 2; k++) {
      ...
      for (int scale = 1; scale <= maxScale; scale++) {
        ...
        //   found = corners.size() == (size_t)(boardSizeInnerCorners.height *
...
int main(int argc, char **argv) {
  ...
  StereoCalib(imagelist, inputBoardSize, "chessboard", squareSize, false,
              showRectified);
